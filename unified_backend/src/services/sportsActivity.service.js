...
const create = async (data, departmentCode, performedBy) => {
  ...
  const record = await sportsActivityRepo.create({
  ...
  await logActivity({
    ...
    action: 'CREATE_SPORTS_ACTIVITY', module: 'sports_activity', recordId: record.id,
...
const update = async (id, data, departmentCode, performedBy) => {
  ...
  const record = await sportsActivityRepo.update(id, updateData);

  await logActivity({
    performedBy, departmentCode,
    action: 'UPDATE_SPORTS_ACTIVITY', module: 'sports_activity', recordId: id,
...
const remove = async (id, departmentCode, performedBy) => {
  ...
  await logActivity({
    performedBy, departmentCode,
    action: 'DELETE_SPORTS_ACTIVITY', module: 'sports_activity', recordId: id,
