 ...
 * Exact copy of hod-portal/src/components/navigation/Topbar.tsx
...
import { Menu, Sun, Moon, ChevronDown, User, LogOut } from '../icons';
...
const styles = StyleSheet.create({
  ...
  profileName: { fontSize: 13, fontWeight: '500', color: neutral[700], maxWidth: 100 },
  ...
  profileSheet: {
    ...
    borderColor: neutral[100], overflow: 'hidden', ...shadows.soft,
  },
  profileInfo: {
  ...
  profileFullName: { fontSize: 13, fontWeight: '600', color: neutral[900] },
  profileUsername: { fontSize: 11, color: neutral[500], marginTop: 1 },
  ...
  profileActionText: { fontSize: 13, color: neutral[700], fontWeight: '500' },
});
